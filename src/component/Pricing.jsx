        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-stretch md:grid-cols-3 md:gap-8">
          <div className="divide-y divide-gray-200 rounded-2xl border border-gray-200 shadow-xs">
            <div className="p-6 sm:px-8">
              ...
              <a className="mt-4 block rounded-sm border border-amber-600 bg-amber-600 px-12 py-3 text-center text-sm font-medium text-white hover:bg-transparent hover:text-amber-600 focus:ring-3 focus:outline-hidden sm:mt-6" href="#">
                Get Started
              </a>
            </div>
            ...
            <div className="p-6 sm:px-8">
              ...
              <ul className="mt-2 space-y-2 sm:mt-4">
                <li className="flex items-center gap-1">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-5 text-amber-700 shadow-sm">
