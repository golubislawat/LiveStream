          ...
          <div className="flex justify-between items-center gap-12 md:flex-row flex-col">
            ...
            <div className="flex items-center mt-6 md:mt-0 gap-4">
              <div className="relative w-full md:w-64">
                ...
                <input type="email" placeholder="Enter your RoomID" className="w-full pl-12 pr-3 py-2 text-gray-500 bg-white outline-none border focus:border-amber-600 shadow-sm rounded-lg"/>
              </div>
              <button className="py-3 px-4 font-medium text-lg text-center text-white bg-amber-600 hover:bg-amber-500 active:bg-amber-700 active:shadow-none rounded-lg shadow">
                Join Now
              </button>
            </div>
          </div>
